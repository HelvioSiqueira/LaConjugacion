...
fun VerbTenseEnum.getJsonFiles(): List<String> {
    ...
    return when (this) {
        VerbTenseEnum.PRESENT_INDICATIVE -> listOf(
        ...
        VerbTenseEnum.CONDITIONAL_SIMPLE -> listOf(
        ...
        VerbTenseEnum.FUTURE_SIMPLE -> listOf(
        ...
        VerbTenseEnum.IMPERFECT_TENSE -> listOf(
        ...
        VerbTenseEnum.PRETERITE_INDEFINITE -> listOf(
        ...
        VerbTenseEnum.PRESENT_SUBJUNCTIVE -> listOf(
